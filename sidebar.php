...
<form method="POST" action="theme_index.php?p=accomodation&q=<?php echo isset($_GET['q']) ? $_GET['q'] : ''; ?>">
            ...
            <h3>Types of Rooms</h3> 
              ...
              <ul  class="a"> 
                ...
                <?php  foreach ($cur as $result) { ?>
                 <li><a href="<?php echo WEB_ROOT; ?>theme_index.php?p=rooms&q=<?php echo $result->ROOM; ?>" ><p ><?php echo $result->ROOM; ?></p></a></li> 
                <?php  } ?>
